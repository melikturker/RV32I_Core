...
def cmd_build(args):
    if args.mode not in ["headless", "gui"]:
        log_error("Invalid mode. Use --mode headless or --mode gui")
        sys.exit(1)
...
\033[1mCOMMAND OVERVIEW\033[0m
  ...
  \033[93m3. BUILD SIMULATOR\033[0m
     \033[1m./runner.py build [--mode {headless|gui}]\033[0m
...
\033[1mQUICK START EXAMPLES:\033[0m
  • Run the colors demo:       \033[96m./runner.py run --gui app/colors_riscv.s\033[0m
...
"""
    ...
    p_build.add_argument("--mode", choices=["headless", "gui"], default="headless", 
